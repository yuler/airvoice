...
export function AndroidIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#3ddc84" aria-hidden="true">
...
export function MacOSIcon({ size = 24 }: { size?: number }) {
  const id = `finder-mask-${size}`;
  return (
